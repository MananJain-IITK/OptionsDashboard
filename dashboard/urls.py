...
urlpatterns = [
    ...
    path('open-interest/', views.open_interest_analytics, name='open_interest_analytics'),
    path('greeks/', views.greeks_calculator, name='greeks_calculator'),
    path('iv-smile/', views.iv_smile, name='iv_smile'),
    path('api/open-interest-data/', views.get_open_interest_data, name='get_open_interest_data'),
